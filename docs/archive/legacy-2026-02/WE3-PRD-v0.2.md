# WE3 PRD v0.2 — Demand-Side Activation & Brief Builder (Agency Front Desk)
...
**One-liner:** A public-facing agency front desk that communicates the WE3 story and model, clarifies who we serve and how we work, and offers a client‑side brief builder that helps prospects self‑qualify and generate crisp briefs with fit checks — all while keeping data local.

- **Problem statement:** Prospects and community members cannot quickly self‑qualify or produce a clear brief. Leads arrive noisy, causing slow time‑to‑first‑call and lower close confidence. Meanwhile, the market is shifting away from junior‑heavy consulting toward senior‑led, hands‑on teams — and the apprenticeship pipeline is breaking.
- **Evidence:** WE3 positioning emphasizes clarity first; the triad model depends on strong briefs; current inbound lacks consistent structure; the story of small senior teams needs to be visible and credible.
- **Users/Segments:** 
  - **Clients seeking clarity** (PE/corp innovation teams, founders, operators)
  - **The product development community** (builders who use our tools/resources)
  - **The next generation** (apprentices looking for real work + mentorship)
- **Jobs to Be Done:** “When I explore WE3, I want to understand the model, see the types of engagements, see proof of work, and generate a credible brief so I can decide to engage.”
- **Why WE3 (story):** Small senior triads (product/design/engineering) with fractional surge and apprentice layers outperform large leveraged teams on uncertain problems. WE3 bridges strategy ↔ execution, co‑builds where it makes sense, incubates internal ventures, and publishes a clarity tool as a goodwill GTM differentiator.
...
**Three‑layer team model:** Core senior triad + fractional specialists + apprentice triad. This structure balances accountability, surge capacity, and mentorship.

**Engagement modes:** 
- **Consulting:** Senior‑led, hands‑on delivery for complex client problems.
- **Co‑building:** Venture‑partner style collaboration with founders/teams, often with shared risk/reward.
- **Venture creation:** Internal or community‑led ventures incubated and spun out by WE3.
- **Community engagement:** Open resources, tools, and events that keep the ecosystem sharp and connected.
...
## 3. Goals & Non-Goals
- **Goals:** 
  - Communicate the WE3 story, team model, and engagement modes with clarity and confidence.
  - Enable self‑qualification and produce high‑quality briefs via a fast‑pass chat.
  - Shorten time‑to‑first‑call; set expectations on crew shape/cost/timeline bands.
  - Establish WE3 as a clarity‑first partner and community contributor.
...
Visitors learn why WE3 exists, who it serves, and how the triad model works — including the three‑layer team structure and engagement modes. They see proof and case studies, then launch a fast‑pass chat. In ~6–8 prompts, they generate a brief with a client‑side fit check (crew shape + week/cost band), copy/export locally, and optionally share a short‑lived link.

**User Stories**

- As a prospect, I can view who WE3 is for, understand the triad model, and see proof points before starting
- As a prospect, I can understand the three engagement modes (consulting, co‑building, venture creation) and how WE3 works with community
...
- Views: Why WE3 exists, who we serve, triad/crew model (three layers), engagement modes, cost/timeline bands, case studies, community proof
...
- **Must-haves:**
  ...
  - R6: Clear IA for demand-side proof: who WE3 is for, why WE3 exists, triad/crew model (core + fractional + apprentices), engagement modes (consulting, co‑building, venture creation, community engagement), cost/timeline bands, and case studies.
...
- **Models/infra:** External API (e.g., OpenAI/Gemini) with **no-log vendor** configuration; explicit user consent required before data transmission.
...
- Story sections that make the WE3 model legible (why small teams, triad structure, and engagement modes)
...
Client-side eventing using **PostHog** (EU instance) for privacy-respecting analytics:
- Events stored with anonymous session ID (no PII)
- Autocapture disabled for Brief Generator fields to ensure privacy
...
- Story/positioning: `docs/Small Teams for Big Challenges.md`
- Future: example prompts, fit-check rule table, `docs/sitemap.md`, brand/tone notes.
